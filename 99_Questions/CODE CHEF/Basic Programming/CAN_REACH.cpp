...
The first line contains three integers xx, yy, KK.
Output Format
...
NO
Explanation
Test case 1: Here K=1K=1, One of the paths that the first-year student can follow is described as: (0,0)(0,0) to (1,0)(1,0) to (1,1)(1,1) to (1,2)(1,2). Hence, he can reach the hostel coordinate at (x,y)=(1,2)(x,y)=(1,2) with the K=1K=1 constraint.

Test case 2: As here K=2K=2, it can be proved that there is no path to move from (0,0)(0,0) to (3,−5(3,−5) by only increasing or decreasing any coordinate by exactly K=2K=2.

Test case 3: Here K=3K=3, One of the paths that the first-year student can follow is described as: (0,0)(0,0) to (−3,0)(−3,0) to (−3,−3)(−3,−3) to (−3,−6)(−3,−6) to (−6,−6)(−6,−6) to (−9,−6)(−9,−6). Hence, he can reach the hostel coordinate at (x,y)=(−9,−6)(x,y)=(−9,−6) with the K=3K=3 constraint.
*/
